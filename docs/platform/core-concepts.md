...
Sections can also be constructed by referencing other sections from component forms _imported in_ using the [Reference forms](/platform/referencing-forms) feature.
